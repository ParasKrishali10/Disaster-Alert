...
if st.sidebar.button("INITIATE MULTI-HAZARD ANALYSIS", type="primary", use_container_width=True):
    with st.spinner("Synchronizing Satellite & Atmospheric Telemetry..."):
        ...
        with st.expander("🔬 View Extracted Geospatial & Meteorological Telemetry"):
            st.markdown("#### ⛰️ Topographical & Biological Data")
        ...
        # ==========================================
        # 10. AI CONSENSUS TABS
        # ==========================================
        st.markdown("### 🧠 AI Engine Consensus Breakdown")
        tab1, tab2, tab3 = st.tabs(["🌲 Fire Analytics", "⛈️ Precipitation Analytics", "⛰️ Terrain Analytics"])

        with tab1:
            st.write("Cross-validation of individual base models for Forest Fire Ignition.")
        ...
        with tab2:
            st.write("Cross-validation of individual base models for Extreme Rainfall.")
        ...
        with tab3:
            st.write("Cross-validation of scaled geospatial and antecedent moisture models.")
